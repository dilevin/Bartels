% LINEAR_TETMESH_NEOHOOKEAN_Q Compute the Neohookean potential energy for a tetmesh with linear shape functions
%
% e = linear_tetmesh_neohookean_q(V,T, q, dphidX, volume, [C D])
%
% Inputs:
...
%   e = linear_tetmesh_neohookean_q(V,T, q, dphidX, vol, [0.5*mu, 0.5*lambda]);