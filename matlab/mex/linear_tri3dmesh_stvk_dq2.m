...
%
% H = linear_tri3dmesh_stvk_dq2(V,T, q, dphidX, volume, N, n, dndq, [lambda mu])
%
% Inputs:
...
%    dphidX  #T by 9 list of per triangle shape function gradients (dphi/dphidX)
...
%   H = linear_tri3dmesh_stvk_dq2(V,T, q, dphidX, N, n, dndq, tri_area, [lambda, mu]);