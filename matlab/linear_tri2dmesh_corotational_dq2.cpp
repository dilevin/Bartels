...
void mexFunction(int nlhs, mxArray *plhs[],
    ...
    if(nrhs > 6) {
        //spd fix
        sim::linear_tri2dmesh_corotational_dq2(H, V, E, q, dphidX, volumes,  params, [](auto &a) {sim::simple_psd_fix(a, 1e-3);});
    } else {
        sim::linear_tri2dmesh_corotational_dq2(H, V, E, q, dphidX, volumes,  params);
    }
