#ifndef SIM_linear_tri2dmesh_stvk_dq_H
#define SIM_linear_tri2dmesh_stvk_dq_H

#include <Eigen/Dense>
#include <EigenTypes.h>

#include <assemble.h>
#include <linear_tri2d_stvk_dq.h>
...
void linear_tri2dmesh_stvk_dq(Eigen::VectorXx<DerivedRet> &H, const Eigen::MatrixBase<DerivedV> &V,  Eigen::Ref<const Eigen::MatrixXi> E,
...
#   include <../src/linear_tri2dmesh_stvk_dq.cpp>
#endif
