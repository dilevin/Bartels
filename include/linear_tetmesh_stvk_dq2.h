#ifndef SIM_linear_tetmesh_stvk_dq2_H
#define SIM_linear_tetmesh_stvk_dq2_H

#include <Eigen/Dense>
#include <EigenTypes.h>

#include <assemble.h>
#include <linear_tet_stvk_dq2.h>
...
void linear_tetmesh_stvk_dq2(Eigen::SparseMatrix<DerivedRet, Options, StorageIndex> &H, const Eigen::MatrixBase<DerivedV> &V,  Eigen::Ref<const Eigen::MatrixXi> E,
...
#   include <../src/linear_tetmesh_stvk_dq2.cpp>
#endif
