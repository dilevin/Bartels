#ifndef SIM_linear_tetmesh_stvk_q_H
#define SIM_linear_tetmesh_stvk_q_H

#include <Eigen/Dense>
#include <EigenTypes.h>

#include <assemble.h>
#include <linear_tet_stvk_q.h>


namespace sim {

template<typename DerivedV, typename DerivedQ, typename DefoType, typename DerivedVol, typename DerivedParam>
auto linear_tetmesh_stvk_q(const Eigen::MatrixBase<DerivedV> &V,  Eigen::Ref<const Eigen::MatrixXi> E,
...
#   include <../src/linear_tetmesh_stvk_q.cpp>
#endif
