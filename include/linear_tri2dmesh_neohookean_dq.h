#ifndef SIM_linear_tri2dmesh_neohookean_dq_H
...
void linear_tri2dmesh_neohookean_dq(Eigen::VectorXx<DerivedRet> &H, const Eigen::MatrixBase<DerivedV> &V,  Eigen::Ref<const Eigen::MatrixXi> E,
