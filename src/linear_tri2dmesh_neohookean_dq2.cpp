...
void sim::linear_tri2dmesh_neohookean_dq2(Eigen::SparseMatrix<DerivedRet, Options, StorageIndex> &out, const Eigen::MatrixBase<DerivedV> &V,  Eigen::Ref<const Eigen::MatrixXi> E,
    ...
    auto assemble_func = [&q, &func](auto &H,  auto &e, 
                           ...
                           { 
                             linear_tri2d_neohookean_dq2(H, q, e, sim::unflatten<3,2>(dphidX), params, volume(0));
