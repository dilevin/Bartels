...
void sim::linear_tri2dmesh_arap_dq(Eigen::VectorXx<DerivedRet> &out, const Eigen::MatrixBase<DerivedV> &V,  Eigen::Ref<const Eigen::MatrixXi> E,
    ...
    auto assemble_func = [&q, &func](auto &H,  auto &e, 
                           ...
                           { 
                             linear_tri2d_arap_dq(H, q, e, sim::unflatten<3,2>(dphidX), params, volume(0));
