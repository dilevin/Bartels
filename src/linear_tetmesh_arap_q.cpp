...
# include<../include/linear_tetmesh_arap_q.h>
#endif

template<typename DerivedV, typename DerivedQ, typename DefoType, typename DerivedVol,typename DerivedParam>
auto sim::linear_tetmesh_arap_q(const Eigen::MatrixBase<DerivedV> &V,  Eigen::Ref<const Eigen::MatrixXi> E,
    ...
    auto assemble_func = [&q](auto &e, 
                           ...
                           { 
                             return linear_tet_arap_q(q, e, sim::unflatten<4,3>(dphidX), params, volume(0));
                           };
