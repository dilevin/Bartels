...
# include<../include/linear_tetmesh_tester_dq.h>
#endif
...
void sim::linear_tetmesh_tester_dq(Eigen::VectorXx<DerivedRet> &out, Eigen::DenseBase<DerivedV> &V,  Eigen::Ref<const Eigen::MatrixXi> E,
    ...
    auto assemble_func = [&q, &func](auto &H,  auto &e, 
                           ...
                           { 
                             linear_tet_tester_dq(H, q, e, sim::unflatten<4,3>(dXinv), params(0,0), params(0,1), volume(0));
