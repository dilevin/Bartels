...
# include<../include/linear_tet_corotational_q.h>
#endif

template<typename DefoType, typename DerivedV, typename Scalar, typename DerivedParams>
auto sim::linear_tet_corotational_q(const Eigen::MatrixBase<DerivedV> &q, const Eigen::Ref<const Eigen::RowVectorXi> element,  
    ...
    return volume*psi_stretch_F(unflatten<3,3>((B*qe).eval()), [](auto &a, auto &b) { return sim::psi_corotational_S(a,b); }, params);
