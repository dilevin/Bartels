...
# include<../include/linear_tetmesh_stvk_dq.h>
#endif
...
void sim::linear_tetmesh_stvk_dq(Eigen::VectorXx<DerivedRet> &out, const Eigen::MatrixBase<DerivedV> &V,  Eigen::Ref<const Eigen::MatrixXi> E,
    ...
    auto assemble_func = [&q, &func](auto &H,  auto &e, 
                           ...
                           { 
                             linear_tet_stvk_dq(H, q, e, sim::unflatten<4,3>(dphidX), params, volume(0));
