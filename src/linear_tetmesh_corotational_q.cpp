...
auto sim::linear_tetmesh_corotational_q(Eigen::MatrixBase<DerivedV> &V,  Eigen::Ref<const Eigen::MatrixXi> E,
    ...
    auto assemble_func = [&q](auto &e, 
                           ...
                           { 
                             return linear_tet_corotational_q(q, e, sim::unflatten<4,3>(dXinv), params, volume(0));
                           };
