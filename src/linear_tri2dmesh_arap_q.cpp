...
# include<../include/linear_tri2dmesh_arap_q.h>
#endif

template<typename DerivedV, typename DerivedQ, typename DefoType, typename DerivedVol,typename DerivedParam>
auto sim::linear_tri2dmesh_arap_q(const Eigen::MatrixBase<DerivedV> &V,  Eigen::Ref<const Eigen::MatrixXi> E,
    ...
    auto assemble_func = [&q](auto &e, 
                           ...
                           { 
                             return linear_tri2d_arap_q(q, e, sim::unflatten<3,2>(dphidX), params, volume(0));
                           };
