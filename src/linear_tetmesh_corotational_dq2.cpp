...
template<typename DerivedRet, int Options, typename StorageIndex,
         typename DerivedV, typename DerivedQ, typename DefoType, typename DerivedVol, 
         typename DerivedParam, typename ElementMatrixCallback>
void sim::linear_tetmesh_corotational_dq2(Eigen::SparseMatrix<DerivedRet, Options, StorageIndex> &out, const Eigen::MatrixBase<DerivedV> &V,  Eigen::Ref<const Eigen::MatrixXi> E,
    ...
    auto assemble_func = [&q, &func](auto &H,  auto &e, 
                           ...
                           { 
                             linear_tet_corotational_dq2(H, q, e, sim::unflatten<4,3>(dphidX), params, volume(0));
