...
void sim::linear_tetmesh_corotational_dq2(Eigen::SparseMatrix<DerivedRet, Options, StorageIndex> &out, Eigen::MatrixBase<DerivedV> &V,  Eigen::Ref<const Eigen::MatrixXi> E,
