...
# include<../include/linear_tet_corotational_dq2.h>
#endif

template<typename HessianType, typename DefoType, typename DerivedV, typename Scalar, typename DerivedParams>
void sim::linear_tet_corotational_dq2(Eigen::DenseBase<HessianType> &out, const Eigen::MatrixBase<DerivedV> &q, const Eigen::Ref<const Eigen::RowVectorXi> element,  
    ...
    d2psi_stretch_dF2(dF, unflatten<3,3>((B*qe).eval()), [](auto &a, auto &b, auto &c) { sim::dpsi_corotational_dS(a,b,c); }, [](auto &a, auto &b, auto &c) { sim::d2psi_corotational_dS2(a,b,c); },  params);
