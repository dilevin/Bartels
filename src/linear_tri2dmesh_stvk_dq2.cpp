...
void sim::linear_tri2dmesh_stvk_dq2(Eigen::SparseMatrix<DerivedRet, Options, StorageIndex> &out, Eigen::MatrixBase<DerivedV> &V,  Eigen::Ref<const Eigen::MatrixXi> E,
